...
function VerifierDashboard({
  ...
  const handleRowClick = async (transaction) => {
    ...
    if (transaction.period_covered) {
      const [startDate, endDate] = transaction.period_covered.split(' - ').map(date => new Date(date));
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      <input
                        type="text"
                        value={formatDate(editableTransaction.date_issued || editableTransaction.date_bought)}
                        onChange={(e) => handleInputChange(e, editableTransaction.date_issued ? 'date_issued' : 'date_bought')}
                        className="w-full p-1 border rounded"
                      />
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      ...
                      <>
                        ...
                        <td className="border border-gray-300 px-4 py-2">
                          <select
                            ...
                            onChange={(e) => handleInputChange(e, 'active_status')}
                            className="w-full p-1 border rounded"
                          >
