...
function createRouter(pool) {
  ...
  router.get("/check-project-name/:name", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT COUNT(*) as count FROM issuer WHERE project_name = ?",
        [name]
      );
  ...
  router.get("/getLastYearCredits/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT SUM(credit_amount) AS last_year_credits FROM issuer WHERE issuer_address = ? AND YEAR(date_issued) = YEAR(DATE_SUB(CURRENT_DATE(), INTERVAL 1 YEAR))",
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getTotalCreditsActiveAndVerified", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS total_credits FROM issuer WHERE active_status = "0" AND verification_status = "1"'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getActiveAndVerifiedRows", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT * FROM issuer WHERE active_status = "0" AND verification_status = "1" ORDER BY date_issued DESC'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getYearlyAverage/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT AVG(credit_amount) AS yearly_average FROM issuer WHERE issuer_address = ?",
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getVerifiedCredits/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS credits_issued FROM issuer WHERE issuer_address = ? AND verification_status = "1"',
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getRetiredCredits/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS credits_retired FROM issuer WHERE issuer_address = ? AND active_status = "1"',
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getTotalCredits/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT SUM(credit_amount) AS total_credits FROM issuer WHERE issuer_address = ?",
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/getYearlyCredits/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT SUM(credit_amount) AS yearly_credits FROM issuer WHERE issuer_address = ? AND YEAR(date_issued) = YEAR(CURRENT_DATE())",
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/address/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT * FROM issuer WHERE issuer_address = ? ORDER BY timestamp DESC",
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/verified/address/:address", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT * FROM issuer WHERE issuer_address = ?",
        [address]
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/active-rows", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT credit_amount, date_issued FROM issuer WHERE active_status = "0" ORDER BY date_issued ASC'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/retired-rows", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT credit_amount, date_issued FROM issuer WHERE active_status = "1" ORDER BY date_issued ASC'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/retired", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS credit_retired FROM issuer WHERE active_status = "1"'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/verified-count", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT COUNT(*) AS verified_count FROM issuer WHERE verification_status = "1"'
      );
      res.json(rows);
    } catch (error) {
      console.error("Error fetching verified issuer:", error);
  ...
  router.get("/verified/count", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS verified_credits FROM issuer WHERE verification_status = "1"'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/issued", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS credit_issued FROM issuer WHERE active_status = "0"'
      );
      res.json(rows);
    } catch (error) {
      console.error("Error fetching total verified credits:", error);
  ...
  router.get("/count", async (req, res) => {
    try {
      const [rows] = await pool.query(
        "SELECT COUNT(*) AS transaction_count FROM issuer"
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/addresses", async (req, res) => {
    try {
      const [rows] = await pool.query(
        "SELECT COUNT(DISTINCT issuer_address) AS address_count FROM issuer"
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/total", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT SUM(credit_amount) AS credit_count FROM issuer WHERE verification_status = "1"'
      );
      res.json(rows);
    } catch (error) {
      console.error("Error fetching total verified credits:", error);
  ...
  router.get("/unverified/count", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT COUNT(*) AS unverified_count FROM issuer WHERE verification_status = "0"'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/unverified", async (req, res) => {
    try {
      const [rows] = await pool.query(
        'SELECT * FROM issuer WHERE verification_status = "0"'
      );
      res.json(rows);
    } catch (error) {
  ...
  router.get("/:txHash", async (req, res) => {
    ...
    try {
      const [rows] = await pool.query(
        "SELECT * FROM issuer WHERE transaction_hash = ?",
        [txHash]
      );
      res.json(rows);
    } catch (error) {
